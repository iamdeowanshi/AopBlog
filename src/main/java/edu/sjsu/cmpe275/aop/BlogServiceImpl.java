...
public class BlogServiceImpl implements BlogService{
	...
	public void shareBlog(String userId, String blogUserId, String targetUserId)
			throws AccessDeniedExeption, NetworkException, IllegalArgumentException {
		System.out.printf("User %s shares user %s's blog with user %s\n", userId, blogUserId, targetUserId);
		// TODO Auto-generated method stub
		counter++;
		if ( targetUserId == "alex")
			throw new ArrayIndexOutOfBoundsException("lolz");

	}

	@Override
	public void unshareBlog(String userId, String targetUserId) throws AccessDeniedExeption, NetworkException, IllegalArgumentException {
		// TODO Auto-generated method stub
	...
	public void commentOnBlog(String userId, String blogUserId, String message)
			throws AccessDeniedExeption, IllegalArgumentException, NetworkException, IllegalArgumentException {
		// TODO Auto-generated method stub
